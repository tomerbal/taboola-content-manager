...
d.img);e.attr("itemId",d.id);$("#dashboardTableBody").append(e)}})}function paging(a){$(".pagination").find(".active").removeClass("active");a=parseInt(a.innerText)-1;0<Object.keys(config.filters).length?getFilteredData(a):getAllData(a)};
